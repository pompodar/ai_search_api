...
PERSIST_DIRECTORY = f"{ROOT_DIRECTORY}/DB/user-" + sys.argv[2]
...
def main():
    ...
    # loader = TextLoader("/home/ai_search/laravel/storage/app/public/users-files/p1/test.txt")
    ...
    vectordb = Chroma.from_documents(documents=texts, embedding=embeddings, persist_directory=TARGET_DIRECTORY)
